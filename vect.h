...
// Exception(Address Instruction)
#pragma interrupt (Excep_AddressInst)
void Excep_AddressInst(void);
...
// ICU GROUPIE0
#pragma interrupt (Excep_ICU_GROUPIE0(vect=17))
void Excep_ICU_GROUPIE0(void);
...
// SSIE0 SSITXI0
#pragma interrupt (Excep_SSIE0_SSITXI0(vect=46))
void Excep_SSIE0_SSITXI0(void);

// SSIE0 SSIRXI0
#pragma interrupt (Excep_SSIE0_SSIRXI0(vect=47))
void Excep_SSIE0_SSIRXI0(void);

// SSIE1 SSIRTI1
#pragma interrupt (Excep_SSIE1_SSIRTI1(vect=48))
void Excep_SSIE1_SSIRTI1(void);

// vector 49 reserved

// RIIC1 RXI1
#pragma interrupt (Excep_RIIC1_RXI1(vect=50))
void Excep_RIIC1_RXI1(void);

// RIIC1 TXI1
#pragma interrupt (Excep_RIIC1_TXI1(vect=51))
