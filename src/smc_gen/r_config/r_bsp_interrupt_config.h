...
#define BSP_MAPPED_INT_CFG_B_VECT_USB1_USBI1                              
...
#define BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUWR                             
#define BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSURD                             
#define BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUFN                             
