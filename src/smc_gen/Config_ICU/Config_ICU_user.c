...
#pragma interrupt r_Config_ICU_irq10_interrupt(vect=VECT(ICU,IRQ10),fint)
#else
#pragma interrupt r_Config_ICU_irq10_interrupt(vect=VECT(ICU,IRQ10))
#endif
static void r_Config_ICU_irq10_interrupt(void)
{
...
#if FAST_INTERRUPT_VECTOR == VECT_ICU_IRQ14
#pragma interrupt r_Config_ICU_irq14_interrupt(vect=VECT(ICU,IRQ14),fint)
#else
#pragma interrupt r_Config_ICU_irq14_interrupt(vect=VECT(ICU,IRQ14))
#endif
static void r_Config_ICU_irq14_interrupt(void)
{
