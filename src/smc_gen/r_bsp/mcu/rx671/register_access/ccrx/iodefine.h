...
/*******************************************************************************
*
* Device     : RX/RX600/RX671
*
* File Name  : iodefine.h
*
* Abstract   : Definition of I/O Register.
*
* History    : V0.40  (2020-06-18)  [Hardware Manual Revision : 0.30]
*            : V0.50  (2020-09-08)  [Hardware Manual Revision : 0.30]
*            : V0.50A (2020-09-28)  [Hardware Manual Revision : 0.30]
*            : V0.50B (2020-09-30)  [Hardware Manual Revision : 0.30]
*            : V0.50C (2020-10-09)  [Hardware Manual Revision : 0.30]
...
/*                                                                              */
/********************************************************************************/
#ifndef __RX671IODEFINE_HEADER__
#define __RX671IODEFINE_HEADER__
...
#define	IEN_RIICHS0_RXI		IEN6
#define	IEN_RIICHS0_TXI		IEN7
...
#define	VECT_RIICHS0_RXI	118
#define	VECT_RIICHS0_TXI	119
...
#define	MSTP_CTSU		SYSTEM.MSTPCRD.BIT.MSTPD12
#define	MSTP_REMC0		SYSTEM.MSTPCRD.BIT.MSTPD7
#define	MSTP_RIICHS0	SYSTEM.MSTPCRD.BIT.MSTPD5
#define	MSTP_RSCI10		SYSTEM.MSTPCRD.BIT.MSTPD3
#define	MSTP_RSCI11		SYSTEM.MSTPCRD.BIT.MSTPD2
#define	MSTP_QSPIX		SYSTEM.MSTPCRD.BIT.MSTPD1
...
#define	IS_QSPIX_ERI		IS30
#define	IS_RIICHS0_TEI		IS12
#define	IS_RIICHS0_EEI		IS13
...
#define	EN_QSPIX_ERI		EN30
#define	EN_RIICHS0_TEI		EN12
#define	EN_RIICHS0_EEI		EN13
...
#define	GEN_QSPIX_ERI			GENAL0
#define	GEN_RIICHS0_TEI			GENAL1
#define	GEN_RIICHS0_EEI			GENAL1
...
#define	GRP_QSPIX_ERI			GRPAL0
#define	GRP_RIICHS0_TEI			GRPAL1
#define	GRP_RIICHS0_EEI			GRPAL1
...
#define	QSPIX		(*(volatile struct st_qspix      __evenaccess *)0x74000000)
#define	RAM			(*(volatile struct st_ram        __evenaccess *)0x81200)
#define	REMC0		(*(volatile struct st_remc       __evenaccess *)0x8C29C)
...
#define	RIICHS0		(*(volatile struct st_riichs     __evenaccess *)0xEC014)
...
#define	RSPIA0		(*(volatile struct st_rspia      __evenaccess *)0xE2800)
...
#define	SMCI10		(*(volatile struct st_smci       __evenaccess *)0xD0040)
#define	SMCI11		(*(volatile struct st_smci       __evenaccess *)0xD0060)
#define	SMCI12		(*(volatile struct st_smci       __evenaccess *)0x8B300)
#define	SSIE0		(*(volatile struct st_ssie       __evenaccess *)0x8A500)
...
IR_USB1_D0FIFO1,IR_USB1_D1FIFO1,
IR_RSPI0_SPRI0,IR_RSPI0_SPTI0,
IR_RSPI1_SPRI1,IR_RSPI1_SPTI1,
IR_RSCI11_RXI,IR_RSCI11_TXI,
IR_SDHI_SBFAI,
IR_SSIE0_SSITXI0=46,IR_SSIE0_SSIRXI0,
IR_RSPIA0_SPRI,IR_RSPIA0_SPTI,
IR_RIIC1_RXI1,IR_RIIC1_TXI1,
...
IR_ICU_GROUPBE0,
IR_RSPI2_SPRI2=108,IR_RSPI2_SPTI2,
...
DTCE_SDHI_SBFAI,
DTCE_SSIE0_SSITXI0=46,DTCE_SSIE0_SSIRXI0,
...
DTCE_RIICHS0_RXI,DTCE_RIICHS0_TXI,
...
IER_USB1_D0FIFO1=0x04,IER_USB1_D1FIFO1=0x04,
...
IER_RIICHS0_RXI=0x0E,IER_RIICHS0_TXI=0x0E,
...
IPR_USB1_D0FIFO1=36,IPR_USB1_D1FIFO1=37,
...
IPR_RIICHS0_RXI=118,IPR_RIICHS0_TXI=119,
...
typedef struct st_qspix {
	union {
		unsigned long LONG;
		struct {
			unsigned long :16;
			unsigned long SRIS:1;
			unsigned long :5;
			unsigned long DODE:1;
			unsigned long CKMD:1;
			unsigned long :1;
			unsigned long PFE:1;
			unsigned long SSE:2;
			unsigned long :1;
			unsigned long RISEL:3;
		} BIT;
	} SPMR0;
	union {
		unsigned long LONG;
		struct {
			unsigned long :26;
			unsigned long SSSU:1;
			unsigned long SSHLD:1;
			unsigned long SSHW:4;
		} BIT;
	} SPSSCR;
	union {
		unsigned long LONG;
	...
	union {
		...
		struct {
			unsigned long :24;
			unsigned long PFOSF:1;
			unsigned long PBFUL:1;
			unsigned long :1;
			unsigned long PBLVL:5;
		} BIT;
	} SPPFSR;
	unsigned long  SPDR;
	union {
	...
	union {
		...
		struct {
			...
			unsigned long XIPE:1;
			unsigned long XIPS:1;
			unsigned long :2;
			unsigned long DCYC:4;
		} BIT;
	} SPDCR;
	char           wk1[4];
	union {
...
typedef struct st_riichs {
	...
	union {
		...
		struct {
			unsigned long :16;
			unsigned long HSME:1;
			unsigned long FMPE:1;
			unsigned long :1;
			unsigned long SMBS:1;
			unsigned long :3;
	...
	union {
		...
		struct {
			unsigned long :13;
			unsigned long SAR2E:1;
			unsigned long SAR1E:1;
			unsigned long SAR0E:1;
			unsigned long HOAE:1;
			unsigned long :8;
			unsigned long DIDE:1;
			unsigned long HSMCE:1;
			unsigned long :4;
			unsigned long GCAE:1;
		} BIT;
	} ICSCR;
	char           wk2[8];
	union {
	...
	union {
		...
		struct {
			unsigned long :30;
			unsigned long WAITRE:1;
			unsigned long WAITAE:1;
		} BIT;
	} ICCSCR;
	char           wk5[152];
	union {
	...
	union {
		...
		struct {
			...
			unsigned long ALE:1;
			unsigned long :7;
			unsigned long TEDE:1;
			unsigned long :3;
			unsigned long NAKDE:1;
			unsigned long :2;
...
typedef struct st_system {
	...
	union {
		...
		struct {
			unsigned char :5;
			unsigned char DTADIE:1;
			unsigned char DRMCIE:1;
	...
	union {
		...
		struct {
			unsigned char :5;
			unsigned char DTADIF:1;
			unsigned char DRMCIF:1;
	...
	union {
		...
		struct {
			unsigned char :1;
			unsigned char TAMP2EE:1;
			unsigned char TAMP1EE:1;
			unsigned char TAMP0EE:1;
			unsigned char :1;
			unsigned char TAMP2IE:1;
			unsigned char TAMP1IE:1;
			unsigned char TAMP0IE:1;
		} BIT;
	} TAMPCR;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :5;
			unsigned char TCE2S:1;
			unsigned char TCE1S:1;
			unsigned char TCE0S:1;
		} BIT;
	} TCECR;
	char           wk22[1];
	union {
		...
		struct {
			unsigned char :5;
			unsigned char CH2EN:1;
			unsigned char CH1EN:1;
			unsigned char CH0EN:1;
		} BIT;
	} TAMPICR1;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :1;
			unsigned char CH2TRG:1;
			unsigned char CH1TRG:1;
			unsigned char CH0TRG:1;
			unsigned char :1;
			unsigned char CH2NFE:1;
			unsigned char CH1NFE:1;
			unsigned char CH0NFE:1;
		} BIT;
	} TAMPICR2;
	union {
		unsigned char BYTE;
		struct {
			unsigned char :5;
			unsigned char CH2LVL:1;
			unsigned char CH1LVL:1;
			unsigned char CH0LVL:1;
		} BIT;
	} TAMPIMR;
	char           wk23[433];
	unsigned char  BKR[128];
	char           wk24[7791200];
	union {
		unsigned long LONG;
		struct {
			unsigned long :23;
			unsigned long HOCOTRD:9;
		} BIT;
	} HOCOTRR0;
	union {
		unsigned long LONG;
