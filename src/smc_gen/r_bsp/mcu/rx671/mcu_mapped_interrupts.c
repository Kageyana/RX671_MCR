...
*         : 21.11.2023 1.01     Added processing to clear the IR flag.
***********************************************************************************************************************/
...
#if BSP_PRV_VALID_MAP_INT(B, BSP_MAPPED_INT_CFG_B_VECT_USB1_USBI1)
    /* Casting is valid because it matches the type to the right side or argument. */
    BSP_PRV_INT_SELECT(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_USB1_USBI1) = BSP_PRV_INT_B_NUM_USB1_USBI1;
#endif
...
#if BSP_PRV_VALID_MAP_INT(B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUWR)
    /* Casting is valid because it matches the type to the right side or argument. */
    BSP_PRV_INT_SELECT(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUWR) = BSP_PRV_INT_B_NUM_CTSU_CTSUWR;
#endif

#if BSP_PRV_VALID_MAP_INT(B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSURD)
    /* Casting is valid because it matches the type to the right side or argument. */
    BSP_PRV_INT_SELECT(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSURD) = BSP_PRV_INT_B_NUM_CTSU_CTSURD;
#endif

#if BSP_PRV_VALID_MAP_INT(B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUFN)
    /* Casting is valid because it matches the type to the right side or argument. */
    BSP_PRV_INT_SELECT(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUFN) = BSP_PRV_INT_B_NUM_CTSU_CTSUFN;
#endif
...
#if BSP_PRV_VALID_MAP_INT(A, BSP_MAPPED_INT_CFG_A_VECT_RSPI1_SPCI1)
    /* Casting is valid because it matches the type to the right side or argument. */
    BSP_PRV_INT_SELECT(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_RSPI1_SPCI1) = BSP_PRV_INT_A_NUM_RSPI1_SPCI1;
#endif

#if BSP_PRV_VALID_MAP_INT(A, BSP_MAPPED_INT_CFG_A_VECT_RSPI2_SPCI2)
    /* Casting is valid because it matches the type to the right side or argument. */
    BSP_PRV_INT_SELECT(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_RSPI2_SPCI2) = BSP_PRV_INT_A_NUM_RSPI2_SPCI2;
#endif
