...
*         : 30.11.2021 1.01     Added the following macro definition and changed setting of SPCC register.
*                               - BSP_PRV_SPCC_VALUE
*                               - BSP_PRV_SPCC_SPE
*                               - BSP_PRV_SPCC_OCDE
...
#if BSP_CFG_ONCHIP_DEBUGGER_CONECT_ENABLE == 0
    #define BSP_PRV_SPCC_OCDE   (0xfffdffff)  /* Connection of a on-chip debugger after a reset is prohibited. */
#else
    #define BSP_PRV_SPCC_OCDE   (0xffffffff)  /* Connection of a on-chip debugger after a reset is permitted. */
#endif

#define BSP_PRV_SPCC_VALUE    (BSP_PRV_SPCC_SPE & BSP_PRV_SPCC_OCDE)
