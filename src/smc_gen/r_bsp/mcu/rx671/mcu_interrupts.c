...
R_BSP_ATTRIB_STATIC_INTERRUPT void group_al0_handler_isr (void)
{
    ...
    if (1 == ICU.GRPAL0.BIT.IS23)
    {
        ...
        R_BSP_InterruptControl(BSP_INT_SRC_AL0_RSPIA0_SPEI, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
    ...
    if (1 == ICU.GRPAL0.BIT.IS22)
    {
        ...
        R_BSP_InterruptControl(BSP_INT_SRC_AL0_RSPIA0_SPII, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
    ...
    /* AL0 IS30 */
    if (1 == ICU.GRPAL0.BIT.IS30)
    {
        /* BSP_INT_SRC_AL0_QSPIX_ERI */
        R_BSP_InterruptControl(BSP_INT_SRC_AL0_QSPIX_ERI, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
...
R_BSP_ATTRIB_STATIC_INTERRUPT void group_al1_handler_isr (void)
{
    ...
    {
        /* BSP_INT_SRC_AL1_RIICHS0_EEI */
        R_BSP_InterruptControl(BSP_INT_SRC_AL1_RIICHS0_EEI, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }

    /* AL1 IS12 */
    if (1 == ICU.GRPAL1.BIT.IS12)
    {
        /* BSP_INT_SRC_AL1_RIICHS0_TEI */
        R_BSP_InterruptControl(BSP_INT_SRC_AL1_RIICHS0_TEI, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
