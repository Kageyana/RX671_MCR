...
*                               - BSP_CFG_INTERNAL_EXPANSION_BUS_PRIORITY
...
*/
#define BSP_CFG_BACKUP_DOMAIN_SUB_CLOCK_SOURCE    (0)
...
*/
#define BSP_CFG_HOCO_FLL_ENABLE         (0)
...
*/
#define BSP_CFG_NONCACHEABLE_AREA0_ADDR      (0xFFF00000)
...
/* Specifies the start address of non-cacheable area 1.
   ...
   The upper 10 bits are fixed at 1. The lower 4 bits are fixed at 0.
*/
#define BSP_CFG_NONCACHEABLE_AREA1_ADDR      (0xFFF00000)
...
/* Select the priority order for internal expansion bus.
   0 = The order of priority is fixed.
   1 = The order of priority is toggled.
*/
#define BSP_CFG_INTERNAL_EXPANSION_BUS_PRIORITY     (0)
