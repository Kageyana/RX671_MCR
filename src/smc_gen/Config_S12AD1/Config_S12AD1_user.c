...
#if FAST_INTERRUPT_VECTOR == VECT_PERIB_INTB189
#pragma interrupt r_Config_S12AD1_interrupt(vect=VECT(PERIB,INTB189),fint)
#else
#pragma interrupt r_Config_S12AD1_interrupt(vect=VECT(PERIB,INTB189))
#endif
