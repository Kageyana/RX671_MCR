...
#define _0030_AD_TRSB_ELCTRG0N_ELCTRG1N      (0x0030U) /* A/D start source from the ELC */
...
#define _3000_AD_TRSA_ELCTRG0N_ELCTRG1N      (0x3000U) /* A/D start source from the ELC */
...
#define _30_AD_TRSC_ELCTRG0N_ELCTRG1N        (0x30U) /* A/D start source from the ELC */
...
typedef enum
{
    ...
    ADCHANNEL8, ADCHANNEL9, ADCHANNEL10, ADCHANNEL11, ADSELFDIAGNOSIS, ADTEMPSENSOR, ADINTERREFVOLT,
