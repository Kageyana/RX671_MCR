...
#define _10_RSPI_READ_SPDR_TX_BUFFER            (0x10U) /* Read SPDR values from transmit buffer 
                                                                        (transmit buffer empty) */
/* RSPI Longword Access/Word Access Specification (SPLW) */ 
#define _00_RSPI_ACCESS_WORD                    (0x00U) /* SPDR is accessed in words */
#define _20_RSPI_ACCESS_LONGWORD                (0x20U) /* SPDR is accessed in long words */

/* RSPI Byte Access Specification (SPBYT) */ 
#define _00_RSPI_ACCESS_WORD_LONGWORD           (0x00U) /* SPDR is accessed in words or long words */
#define _40_RSPI_ACCESS_BYTE                    (0x40U) /* SPDR is accessed in bytes */
...
/* Transfer Data Invert (DINV) */
#define _00_RSPI_DINV_DISABLED                  (0x00U) /* Data is not inverted */
#define _02_RSPI_DINV_ENABLED                   (0x02U) /* Data is inverted */

/*
    RSPI Control Register 3 (SPCR3)
*/
/* Receive Operating Mode (RXMD) */
#define _00_RSPI_RXMD_DISABLED                  (0x00U) /* Full-duplex or transmit-only simplex communications */
#define _01_RSPI_RXMD_ENABLED                   (0x01U) /* Receive-only simplex communications */
/* RSPCK Delay Between Data Byte Disable (SCKDDIS) */
#define _00_RSPI_SCKDDIS_DISABLED               (0x00U) /* Inserts delays*/
#define _02_RSPI_SCKDDIS_ENABLED                (0x02U) /* Does not insert delays */
/* Communication End Interrupt Enable (SPCIE) */
#define _00_RSPI_SPCIE_DISABLED                 (0x00U) /* Disables communication end interrupt requests */
#define _10_RSPI_SPCIE_ENABLED                  (0x10U) /* Enables communication end interrupt requests */
