...
#define BSP_PRV_INT_B_NUM_USB1_USBI1                                      63
...
#define BSP_PRV_INT_B_NUM_CTSU_CTSUWR                                     96
#define BSP_PRV_INT_B_NUM_CTSU_CTSURD                                     97
#define BSP_PRV_INT_B_NUM_CTSU_CTSUFN                                     98
...
#define BSP_PRV_INT_A_NUM_RSPIA0_SPCI                                     90
#define BSP_PRV_INT_A_NUM_RSPI0_SPCI0                                     91
#define BSP_PRV_INT_A_NUM_RSPI1_SPCI1                                     92
#define BSP_PRV_INT_A_NUM_RSPI2_SPCI2                                     93
...
#define IR_USB1_USBI1        BSP_PRV_IR(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_USB1_USBI1)
#define DTCE_USB1_USBI1      BSP_PRV_DTCE(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_USB1_USBI1)
#define IER_USB1_USBI1       BSP_PRIV_CALC_IER_REG(BSP_MAPPED_INT_CFG_B_VECT_USB1_USBI1)
#define IPR_USB1_USBI1       BSP_PRV_IPR(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_USB1_USBI1)
#define IEN_USB1_USBI1       BSP_PRV_IEN(BSP_MAPPED_INT_CFG_B_VECT_USB1_USBI1)
#define VECT_USB1_USBI1      BSP_PRV_VECT(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_USB1_USBI1)
#endif
...
#define IR_CTSU_CTSUWR        BSP_PRV_IR(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUWR)
#define DTCE_CTSU_CTSUWR      BSP_PRV_DTCE(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUWR)
#define IER_CTSU_CTSUWR       BSP_PRIV_CALC_IER_REG(BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUWR)
#define IPR_CTSU_CTSUWR       BSP_PRV_IPR(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUWR)
#define IEN_CTSU_CTSUWR       BSP_PRV_IEN(BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUWR)
#define VECT_CTSU_CTSUWR      BSP_PRV_VECT(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUWR)
#endif

#if BSP_PRV_VALID_MAP_INT(B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSURD)
#define IR_CTSU_CTSURD        BSP_PRV_IR(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSURD)
#define DTCE_CTSU_CTSURD      BSP_PRV_DTCE(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSURD)
#define IER_CTSU_CTSURD       BSP_PRIV_CALC_IER_REG(BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSURD)
#define IPR_CTSU_CTSURD       BSP_PRV_IPR(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSURD)
#define IEN_CTSU_CTSURD       BSP_PRV_IEN(BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSURD)
#define VECT_CTSU_CTSURD      BSP_PRV_VECT(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSURD)
#endif

#if BSP_PRV_VALID_MAP_INT(B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUFN)
#define IR_CTSU_CTSUFN        BSP_PRV_IR(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUFN)
#define DTCE_CTSU_CTSUFN      BSP_PRV_DTCE(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUFN)
#define IER_CTSU_CTSUFN       BSP_PRIV_CALC_IER_REG(BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUFN)
#define IPR_CTSU_CTSUFN       BSP_PRV_IPR(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUFN)
#define IEN_CTSU_CTSUFN       BSP_PRV_IEN(BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUFN)
#define VECT_CTSU_CTSUFN      BSP_PRV_VECT(BSP_PRV_B, BSP_MAPPED_INT_CFG_B_VECT_CTSU_CTSUFN)
#endif
...
#define IR_RSPIA0_SPCI        BSP_PRV_IR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_RSPIA0_SPCI)
#define DTCE_RSPIA0_SPCI      BSP_PRV_DTCE(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_RSPIA0_SPCI)
#define IER_RSPIA0_SPCI       BSP_PRIV_CALC_IER_REG(BSP_MAPPED_INT_CFG_A_VECT_RSPIA0_SPCI)
#define IPR_RSPIA0_SPCI       BSP_PRV_IPR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_RSPIA0_SPCI)
#define IEN_RSPIA0_SPCI       BSP_PRV_IEN(BSP_MAPPED_INT_CFG_A_VECT_RSPIA0_SPCI)
#define VECT_RSPIA0_SPCI      BSP_PRV_VECT(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_RSPIA0_SPCI)
#endif
...
#define IR_RSPI1_SPCI1        BSP_PRV_IR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_RSPI1_SPCI1)
#define DTCE_RSPI1_SPCI1      BSP_PRV_DTCE(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_RSPI1_SPCI1)
#define IER_RSPI1_SPCI1       BSP_PRIV_CALC_IER_REG(BSP_MAPPED_INT_CFG_A_VECT_RSPI1_SPCI1)
#define IPR_RSPI1_SPCI1       BSP_PRV_IPR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_RSPI1_SPCI1)
#define IEN_RSPI1_SPCI1       BSP_PRV_IEN(BSP_MAPPED_INT_CFG_A_VECT_RSPI1_SPCI1)
#define VECT_RSPI1_SPCI1      BSP_PRV_VECT(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_RSPI1_SPCI1)
#endif

#if BSP_PRV_VALID_MAP_INT(A, BSP_MAPPED_INT_CFG_A_VECT_RSPI2_SPCI2)
#define IR_RSPI2_SPCI2        BSP_PRV_IR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_RSPI2_SPCI2)
#define DTCE_RSPI2_SPCI2      BSP_PRV_DTCE(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_RSPI2_SPCI2)
#define IER_RSPI2_SPCI2       BSP_PRIV_CALC_IER_REG(BSP_MAPPED_INT_CFG_A_VECT_RSPI2_SPCI2)
#define IPR_RSPI2_SPCI2       BSP_PRV_IPR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_RSPI2_SPCI2)
#define IEN_RSPI2_SPCI2       BSP_PRV_IEN(BSP_MAPPED_INT_CFG_A_VECT_RSPI2_SPCI2)
#define VECT_RSPI2_SPCI2      BSP_PRV_VECT(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_RSPI2_SPCI2)
#endif
